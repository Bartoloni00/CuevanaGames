...
<template>
  ...
  <div className="mx-auto w-full text-center">
    <div className="px-6">
      <h1 className="text-8l uppercase mb-3 text-7xl font-bold">
        Cuevana Games
      </h1>
    ...
    <section className="mt-4 mx-2">
      ...
      >
        <div className=" rounded-lg shadow-md md:min-h-[550px] w-full">
          ...
          >
            <img
              src="../../public/palanca-de-mando.png"
              alt=""
              width="100"
              height="100"
            />
          ...
          <div className="p-2">
            <p className="text-base text-center">
              ...
              para satisfacer cualquier preferencia. Ya sea que busques juegos
              clásicos, los últimos estrenos o juegos de nicho, tenemos lo que
              estás buscando en nuestra colección diversa y emocionante.
            </p>
          </div>
        </div>
        <div className=" rounded-lg shadow-md md:min-h-[550px] w-full">
          ...
          >
            <img
              src="../../public/gafas-virtuales.png"
              alt=""
              width="100"
              height="100"
            />
          ...
          <div className="p-2">
            <p className="text-base text-center">
              ...
              tanto de las últimas tendencias y novedades de la industria del
              entretenimiento en nuestro catálogo de estrenos más recientes.
            </p>
          </div>
        </div>
        <div className=" rounded-lg shadow-md md:min-h-[550px] w-full">
          ...
          <div className="p-2">
            <p className="text-base text-center">
              ...
              legendarios arcade hasta los inolvidables juegos de consola,
              encuentra tus favoritos y disfruta de la diversión atemporal que
              solo los juegos clásicos pueden ofrecer.
            </p>
          </div>
        </div>
      </div>
    </section>
    <section class="flex flex-col justify-between items-center flex-wrap p-4">
      <h2 class="mb-2 text-2xl font-bold text-center text-black">
      ...
      <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <h3 class="text-base leading-7 text-dark-grey-600">Contactanos</h3>
          <a
            class="text-lg font-bold text-blue-600"
            href="mailto:cuevanagames@gmail.com"
            >hello@loopple.com</a
          >
        </div>
        <div
        ...
        >
          ...
          <h3 class="text-2xl font-extrabold text-dark-grey-900">Telefono</h3>
          <p class="text-base leading-7 text-dark-grey-600">Nuestro telefono</p>
          <a class="text-lg font-bold text-blue-600" href="tel:+516-486-5135"
            >+516-486-5135</a
          >
        </div>
        <div
        ...
        >
          ...
          <h3 class="text-2xl font-extrabold text-dark-grey-900">
            Localizacion
          </h3>
      ...
      <div class="flex flex-wrap justify-between align-middle gap-4">
        ...
        >
          <a href="https://github.com/Bartoloni00" target="_blank">
            <img
              class="rounded-t-lg"
              src="https://avatars.githubusercontent.com/u/116020038?v=4"
              alt=""
            />
          </a>
          <div class="p-5">
        ...
        >
          <a href="https://github.com/Ezearevalodev" target="_blank">
            <img
              class="rounded-t-lg"
              src="https://avatars.githubusercontent.com/u/111710833?v=4"
              alt=""
            />
          </a>
          <div class="p-5">
